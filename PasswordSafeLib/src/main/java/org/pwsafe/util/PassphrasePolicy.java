 ...
 * <li>Digits and certain symbol characters. </sl>
 * </p>
 * <p>
 * In addition it also specifies whether certain confusable characters should be
 * removed from the password. These are characters such as '1' and 'I'.
 */
public class PassphrasePolicy {
	...
	/**
	 * <code>true</code> if generated password should contain lowercase
	 * characters. The default is <code>true</code>.
	 */
	public boolean lowercaseChars = true;

	/**
	 * <code>true</code> if generated password should contain uppercase
	 * characters. The default is <code>true</code>.
	 */
	...
	/**
	 * <code>true</code> if the generated password should contain symbol
	 * characters. The default is <code>true</code>.
	 */
	public boolean symbolChars = true;

	/**
	 * <code>true</code> if the generated password should not contain confusable
	 * characters. The default is <code>false</code>.
	 */
	...
	/**
	 * Creates a password policy with fairly strong deafults. If unaltered this
	 * policy will cause a password to be generated that is 8 characters long
	 * with at least one of each character class, i.e. at least one uppercase,
	...
	/**
	 * Checks that it is possible to generate a password using this policy.
	 * Returns <code>true</code> if at least one character category is selected
	 * and the password length is equal to or greater than the number of classes
	 * selected.
	 * 
	 * @return
	 */
	...
	/**
	 * Creates a Password Policy from a String as defined in formatsV3.txt. The
	 * format is:
	 * 
	 * <pre>
	 * "ffffnnnllluuudddsss"
	...
	public static PassphrasePolicy valueOf(String policyString) {
		...
		final PassphrasePolicy policy = new PassphrasePolicy();
		final String types = policyString.substring(0, 4);
		final int blabla = Integer.parseInt(types, 16);
		...
		// int sublength = Integer.parseInt(policyString.substring(7 + i, 7 + i
		// + 3), 16) ;
		// }
