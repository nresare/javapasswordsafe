...
public class MiscPreferences extends PreferencePage {
	...
	protected Control createContents(final Composite parent) {
		...
		btnCopiesPasswordToClipboard.setText(Messages
				.getString("MiscPreferences.CopyPasswordOnDoubleClick")); //$NON-NLS-1$
	...
	protected void performDefaults() {
		...
		btnSaveImmediately
				.setSelection(preferenceStore.getDefaultBoolean(SAVE_IMMEDIATELY_ON_EDIT));
		btnRecordAccessTime
				.setSelection(preferenceStore.getDefaultBoolean(RECORD_LAST_ACCESS_TIME));
	...
	public boolean performOk() {
		...
		preferenceStore.setValue(DOUBLE_CLICK_COPIES_TO_CLIPBOARD,
				btnCopiesPasswordToClipboard.getSelection());
